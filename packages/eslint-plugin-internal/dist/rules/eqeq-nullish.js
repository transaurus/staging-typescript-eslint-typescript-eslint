        ...
        return {
            BinaryExpression(node) {
                if (node.operator === '===' || node.operator === '!==') {
                    const offendingChild = [node.left, node.right].find(child => (child.type === AST_NODE_TYPES.Identifier &&
                    ...
                    const nullishKind = offendingChild.type === AST_NODE_TYPES.Identifier
                        ? 'undefined'
                        : 'null';
