...
export default createRule({
    ...
    meta: {
        type: 'problem',
        docs: {
            description: 'Disallow multiple errors across multiple lines in RuleTester test outputs',
        },
        messages: {
            multipleLines: 'Prefer writing singular tests rather than asserting for multiple errors across multiple lines in one test.',
        },
        schema: [],
    },
    defaultOptions: [],
    create(context) {
        function getTestCaseLine(element) {
        ...
        function checkInvalidTestCaseErrors(node) {
            let seenLine;
